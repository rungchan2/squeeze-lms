...
import MentionInput, { MentionInputRef } from "@/components/MentionInput/MentionInput";
...
export default function CommentInputSection({ createComment }: CommentInputSectionProps) {
